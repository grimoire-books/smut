...
| Question | Provisional | Why this, for now |
|----------|-------------|-------------------|
| Starting ground | **Manchester** for the unnamed man. Prologue is **not** his town. | Less obvious than London/Dublin. Adult crucible later. Dream should feel like somewhere else. |
| Age / class | Mid-twenties. Working-class rented room, agency/warehouse graft. Elite box not yet. | Floor 20+. Class has to bite. Hannaford energy without a school. |
| Love interest shape | Nest of three, not a single girlfriend. Side-sex first, outside the house. | House Isador cap. Hannaford-slow avoided. |
| The bully | **Joss** — nest-mate. Peer. Posh enough to hurt. | Canavan attack + Hannaford sheathed weapon. Not the kind one. |
| Supernatural visibility | Full masquerade. Papers misread. | Matches §15. |
| Single vs trilogy | **Trilogy.** Length law locks three volumes. | [LENGTH.md](LENGTH.md). |
...
## Still open (do not fake them)

- Witch, shifter
- Exact Samhain/solstice spoken at the pledge
- Final title
- Whether Cairn is sire, house-head, or both (page treats him as house-head for now)
